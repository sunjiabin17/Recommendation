...
def sparseFeature(feat, feat_num, embed_dim=4):
    ...
    :param feat_num: number of sparse features that do not repeat
...
def create_criteo_dataset(file, embed_dim=8, read_part=True, sample_num=10000, test_size=0.2):
    '''
    create criteo dataset
